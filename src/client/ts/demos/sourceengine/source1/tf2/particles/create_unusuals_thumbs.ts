...
const EffectList: Effect[] = [/*
	...
	{ system: 'unusual_classicfortress_teamcolor_red', fov: 25, position: [50, 0, 0], target: [0, 0, 15], wait: 2000, setQuaternion: true },
	{ system: 'unusual_classicfortress_teamcolor_blue', fov: 25, position: [50, 0, 0], target: [0, 0, 15], wait: 2000, setQuaternion: true },
	{ system: 'unusual_classicfortress_tflogo_parent', fov: 25, position: [50, 0, 0], target: [0, 0, 15], wait: 2000, setQuaternion: true },
	{ system: 'unusual_growing_flake_parent_white', fov: 40, position: [50, 0, 0], target: [0, 0, 12], wait: 4000, setQuaternion: true },
	{ system: 'unusual_growing_flake_parent_purple', fov: 40, position: [50, 0, 0], target: [0, 0, 12], wait: 4000, setQuaternion: true },
...
const UnusualTauntList: Effect[] = [
	...
	/*
	// Smissmas 2025 Unusual Taunts
	{ system: 'utaunt_2fort_teamc_teamcolor_red', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_2fort_teamc_teamcolor_blue', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_burningdesire_green_parent', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_burningdesire_orange_parent', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_spacecoated_2colored_parent_pb', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_spacecoated_2colored_parent_pg', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_aurora25_teamcolor_red', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
	{ system: 'utaunt_aurora25_teamcolor_blue', fov: 80, position: [50, -100, 50], target: [0, 0, 45], wait: 2000, isTaunt: true },
