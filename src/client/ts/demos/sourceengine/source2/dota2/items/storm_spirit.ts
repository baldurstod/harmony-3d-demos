...
class Dota2StormSpiritDemo implements Demo {
	static readonly path = 'sourceengine/source2/dota2/items/storm_spirit';
	...
	async initDemo(scene: Scene, params: InitDemoParams): Promise<void> {
		...
		const item = await addSource2Model('dota2', 'models/items/doom/doom_2021_immortal_weapon/doom_2021_immortal_weapon', scene) as Source2ModelInstance;
