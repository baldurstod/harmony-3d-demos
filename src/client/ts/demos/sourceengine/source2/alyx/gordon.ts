...
class Source2GordonDemo implements Demo {
	static readonly path = 'sourceengine/source2/alyx/gordon';
	...
	async initDemo(scene: Scene, params: InitDemoParams): Promise<void> {
		...
		const alyx = (await addSource2Model('hla', 'models/characters/gordon/gordon', scene))!;
...
registerDemo(Source2GordonDemo);
